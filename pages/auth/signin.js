    ...
    return(
        <div className='flex justify-center items-center h-full'>
            ...
            <>
                ...
                <div className="w-11/12 md:w-1/2 lg:w-1/3 xl:w-1/4 bg-white dark:bg-gray-900 dark:text-gray-200 drop-shadow rounded-md p-6 relative">
                    <h1 className='text-indigo-500 dark:text-indigo-300 text-center text-3xl mb-3'>Next-Base</h1>
                    <h2 className='text-gray-500 dark:text-gray-400 text-center text-2xl mb-5'>Connexion</h2>
                    <Formik
                        initialValues={{
                            email: '',
                            password: ''
                        ...
                        {({errors, touched}) => (
                            <Form>
                                <div className="flex flex-col mb-3 text-sm relative">
                                    <label htmlFor="signinEmailInput" className="mb-1 ml-1">Adresse email <span className="text-rose-500">*</span></label>
                                    <Field name='email' type="email" className="p-2 rounded-md bg-gray-100 shadow-inner dark:bg-gray-700" id="signinEmailInput" placeholder="example@example.com" />
                                ...
                                <div className="flex flex-col mb-5 text-sm relative">
                                    <label htmlFor="signinPasswordInput" className="mb-1 ml-1">Mot de passe <span className="text-rose-500">*</span></label>
                                    <Field name="password" type="password" className="p-2 rounded-md bg-gray-100 shadow-inner dark:bg-gray-700" id="signinPasswordInput" placeholder="********" />
