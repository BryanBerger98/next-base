...
export default function Button({variant, href, onClick, disabled, type, children}) {
    ...
    const variants = {
        primary: `bg-indigo-500 text-gray-50 hover:bg-indigo-600 disabled:bg-indigo-400 disabled:text-white ${uiOptions.shadows && 'shadow-md shadow-indigo-500/50 hover:shadow-indigo-600/50'}`,
        danger: `bg-rose-500 text-gray-50 hover:bg-rose-600 disabled:bg-rose-400 disabled:text-white ${uiOptions.shadows && 'shadow-md shadow-rose-500/50 hover:shadow-rose-600/50'}`,
        success: `bg-green-500 text-gray-50 hover:bg-green-600 disabled:bg-green-400 disabled:text-white ${uiOptions.shadows && 'shadow-md shadow-green-500/50 hover:shadow-green-600/50'}`,
        ...
        link: `text-gray-500 hover:underline dark:text-gray-300`
    }
